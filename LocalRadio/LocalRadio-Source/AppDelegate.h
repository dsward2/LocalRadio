...
@class LocalRadioAPI;
@class StreamingServerController;
...
@property (strong) IBOutlet StreamingServerController * streamingServerController;
...
@property (weak) IBOutlet NSTextField * statusStreamingServerTextField;
...
@property (weak) IBOutlet NSTextField * streamingServerHTTPPortTextField;
...
@property (weak) IBOutlet NSTextField * editStreamingServerHTTPPortTextField;
...
@property (assign) NSUInteger streamingServerHTTPPort;
