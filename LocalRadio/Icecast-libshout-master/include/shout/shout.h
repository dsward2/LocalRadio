...
#define SHOUT_FORMAT_AAC            (  4) /* audio/aac (ADTS framing) */
#define SHOUT_FORMAT_AAC_LATMLOAS   (  5) /* audio/aac (LATM/LOAS framing) */
#define SHOUT_FORMAT_AAC_USAC       (  6) /* audio/usac (for xHE-AAC, aot 42) */
