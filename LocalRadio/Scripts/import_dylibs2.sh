...
TARGETS="libao.4.dylib libfec.dylib libfftw3f.3.dylib libFLAC.14.dylib libicudata.65.1.dylib libicui18n.65.1.dylib libicuuc.65.1.dylib libliquid.dylib libltdl.7.dylib libogg.0.dylib libopus.0.dylib libopusfile.0.dylib librtlsdr.0.6git.dylib libsndfile.1.dylib libtheora.0.dylib libusb-1.0.0.dylib libvorbis.0.dylib libvorbisenc.2.dylib libvorbisfile.3.dylib"
